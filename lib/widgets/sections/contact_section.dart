...
class _ContactSectionState extends State<ContactSection> {
  ...
  Future<void> _submitForm() async {
    ...
    try {
      ...
      setState(() {
        _errorMessage =
            'Failed to open email client. Please email directly at althafmdev@gmail.com';
      });
    } finally {
      if (mounted) {
        setState(() {
                            ...
                            Wrap(
                              ...
                              children: [
                                ...
                                _buildSocialLink(
                                  ...
                                  onTap: () => launchUrl(
                                    Uri.parse(
                                      'https://github.com/AlthafMjeelani',
                                    ),
                                  ),
                                ),
                              ],
  ...
  Widget _buildTextField({
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        filled: true,
        fillColor: const Color(0xFF0A0E1A).withValues(alpha: 0.6),
